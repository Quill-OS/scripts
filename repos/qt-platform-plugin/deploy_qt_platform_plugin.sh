#!/bin/bash
exec_remote_rootfs "killall -9 qos qos-bin 2048 2048-bin"
...
exec_remote_gui "env LD_LIBRARY_PATH=/mnt/onboard/.adds/qt-linux-5.15.2-kobo/lib:/lib/:/usr/lib QT_QPA_PLATFORM=kobo:debug /mnt/onboard/.adds/qos/2048-bin"